...
* восстановление при следующем запуске введённого времени и выбранных настроек;
...
Через окно настроек можно выбрать другой JSON-файл настроек или записать настройки в новый файл. Файл может находиться в любой доступной папке и иметь любое имя.

Пример файла настроек для ознакомления с форматом:
